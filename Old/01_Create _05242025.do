...
drop if missing(occ_4)
keep occ_2 occ_4
duplicates drop occ_4, force
save "$temp\piaac_ISCO_Codes.dta", replace


use "$crosswalks\isco_soc_crosswalk.dta", clear
rename ISCO08Code occ_4
merge m:1 occ_4 using "$temp\piaac_ISCO_Codes.dta"
...
use "$temp\isco_soc_crosswalk_clean.dta", clear
merge m:1 SOCCode using "$temp\1990_2010_Merged_DOT_ONET_Final.dta"
